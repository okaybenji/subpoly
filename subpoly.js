/*!
 *  subpoly - a webaudio subtractive polyphonic synthesizer
 *  (c) 2015 Benji Kay
 *  MIT License
 */

/*
 *  TODO: Attach voice array to synth. Make setWaveform and setPitch methods of voice to allow code such as:
 *  synth.voices.forEach(function(voice) {
 *    voice.setPitch(440)
 *  });
 *  TODO: Change setWaveform and setPitch to waveform and pitch; allow getting and setting
 */
